---
target_file: "bones/scripts/tests/rc-glue.bats"
...
Documentation for `bones/scripts/tests/rc-glue.bats`. This file was auto-generated by the Document Improvement Project (DIP).
...
*Not found: no help block for `rc-glue.bats` in autopsy help report.*
## Environment
...
*Not found: no changelog/history entries matching `rc-glue.bats`.*
## Necromancer's Notes
<!-- DIP-SOUL-EXTRACTED: 2026-07-23T12:07:07Z -->

*Not found: no soul sidecar for `bones/scripts/tests/rc-glue.bats`.*
