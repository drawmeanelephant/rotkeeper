...
template: \"$template_name\""
    ...
    # SIDE EFFECT (write): overwrites home/content/showcase/showcase-<theme>.md (frontmatter + demo body)
...
MD_EOF
  ...
  if [[ "$DRY_RUN" == true ]]; then
    ...
    # SIDE EFFECT (write): overwrites home/content/showcase/index.md gallery source
    } > "$gallery_src"
    ...
    # SIDE EFFECT (write): creates output/showcase/ and overwrites its index.html
